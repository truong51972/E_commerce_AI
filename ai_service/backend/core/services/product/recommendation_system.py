...
class RecommendationSystem(Product):
    ...
    def search(
        ...
        sorted_search_results = sorted(combined_search_results, key=lambda x: x.distance, reverse=True)
...
if __name__ == "__main__":
    ...
    for id in res:
        ...
        print(f"Product ID: {id}, Name: {record['product_name']}, Price: {record['price']}")